...
public enum ErrorCode {
    ...
    NOT_MATCH_WRITER(2504, HttpStatus.FORBIDDEN, "작성자만 게시글을 수정 및 삭제할 수 있습니다."),
    ...
    NOT_DELETE_PARENT_COMMENT(2507, HttpStatus.BAD_REQUEST, "관련된 댓글이 존재하는 경우, 해당 대댓글을 삭제할 수 없습니다."),
